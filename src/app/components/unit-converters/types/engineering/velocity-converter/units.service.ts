...
export class UnitsService {
  ...
  units: readonly { key: string; label: string; conversionRate: number,abbreviation?:string}[] = Object.freeze([
    ...
    {key: "mach",label: "Mach",conversionRate: 343.058,abbreviation: "Ma"},
    {key: "light-per-second",label: "Speed of Light (c)",conversionRate: 299792458,abbreviation: "c"},
    {key: "kilometer-per-second",label: "Kilometer per Second",conversionRate: 1000,abbreviation: "km/s"},
    {key: "centimeter-per-second",label: "Centimeter per Second",conversionRate: 0.01,abbreviation: "cm/s"},
    {key: "millimeter-per-second",label: "Millimeter per Second",conversionRate: 0.001,abbreviation: "mm/s"},
    ...
    {key: "microinch-per-second",label: "Microinch per Second",conversionRate: 2.54e-8,abbreviation: "µin/s"},
    {key: "millimeter-per-hour",label: "Millimeter per Hour",conversionRate: 2.77778e-7,abbreviation: "mm/hr"},
    {key: "centimeter-per-hour",label: "Centimeter per Hour",conversionRate: 0.00000277778,abbreviation: "cm/hr"},
    {key: "kilometer-per-millisecond",label: "Kilometer per Millisecond",conversionRate: 1000000,abbreviation: "km/ms"},
    {key: "meter-per-millisecond",label: "Meter per Millisecond",conversionRate: 1000,abbreviation: "m/ms"},
    {key: "foot-per-millisecond",label: "Foot per Millisecond",conversionRate: 0.3048,abbreviation: "ft/ms"},
    {key: "inch-per-millisecond",label: "Inch per Millisecond",conversionRate: 0.0254,abbreviation: "in/ms"
    }
]);
