...
export class UnitsService {
  ...
  units: readonly { key: string; label: string; conversionRate: number }[] = Object.freeze([
      ...
      { key: "btu-it", label: "BTU (International Table)", conversionRate: 1054.35 },
      { key: "btu-th", label: "BTU (Thermochemical)", conversionRate: 1054.35 },
      ...
      { key: "thermie", label: "Thermie", conversionRate: 4185800 },
      ...
      { key: "calorie-15-degree-celsius", label: "Calorie (15°C)", conversionRate: 4.1858 },
      ...
      { key: "calorie-20-degree-celsius", label: "Calorie (20°C)", conversionRate: 4.182 },
